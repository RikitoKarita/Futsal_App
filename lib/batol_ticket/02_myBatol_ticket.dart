...
class myBatolTicket extends StatefulWidget {
  @override
  _myBatolTicketState createState() => _myBatolTicketState();
}

class _myBatolTicketState extends State<myBatolTicket> {
  List<Batol_TBL> Batol_Tbl_List = [];

  Future<void> myBatolTicket() async {
