...
class othersBatol_Serch extends StatefulWidget {
  @override
  _othersBatol_SerchState createState() => _othersBatol_SerchState();
}

class _othersBatol_SerchState extends State<othersBatol_Serch> {
                                ...
                                onTap: (){
                                  Navigator
                                    ...
                                    BatolTicketDetail.make(
                                        ...
                                        Batol_Tbl_List[index].TEAM_LEVEL,
                                          Batol_Tbl_List[index].BATOL_DATE,
                                          Batol_Tbl_List[index].DESIRED_LEVEL,
                                          Batol_Tbl_List[index].FREESPACE,
                                          Batol_Tbl_List[index].LOCATION,
                                          Batol_Tbl_List[index].RESERVED_FLG,
                                          Batol_Tbl_List[index].IMAGE_PASS,
                                          Batol_Tbl_List[index].UPDATE_AT)
                                  ));
                                },
                              ),
                            );
